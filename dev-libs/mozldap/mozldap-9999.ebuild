...
inherit eutils multilib versionator cvs

DESCRIPTION="Mozilla LDAP C SDK"
HOMEPAGE="http://wiki.mozilla.org/LDAP_C_SDK"
SRC_URI=""

ECVS_MODULE="mozilla/directory/c-sdk"
ECVS_SERVER="cvs-mirror.mozilla.org:/cvsroot"

LICENSE="MPL-1.1 GPL-2 LGPL-2.1"
SLOT="0"
KEYWORDS=""
IUSE="ipv6 debug +sasl +threads"

DEPEND="=dev-libs/nss-9999
	=dev-libs/nspr-9999
	=dev-libs/svrcore-9999
	sasl? ( dev-libs/cyrus-sasl )
	dev-util/pkgconfig"

RDEPEND="=dev-libs/nss-9999
		=dev-libs/nspr-9999
		sasl? ( dev-libs/cyrus-sasl )"

S="${WORKDIR}"/mozilla/directory/c-sdk
...
src_configure() {
	...
	econf $(use_enable debug) \
		...
		$(use_with threads user-pthreads) \
...
src_install () {
	...
	local MY_S="${WORKDIR}"/mozilla/dist/
