...
# original ebuild - /var/cvsroot/gentoo-x86/dev-java/jss/jss-4.2.5.ebuild,v 1.2 2008/05/28 19:20:28 maekke Exp $
...
#    -r JSS_4_3_RTM mozilla/security/corefonf
# cvs -d :pserver:anonymous@cvs-mirror.mozilla.org:/cvsroot export \
#    -r JSS_4_3_RTM mozilla/security/jss
# tar cvjf jss-4.3.tar.bz2 mozilla
SRC_URI="http://slepnoga.googlecode.com/files/${P}.tar.bz2"
