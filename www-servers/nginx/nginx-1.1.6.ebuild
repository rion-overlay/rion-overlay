...
# NginX DevKit module (https://github.com/chaoslawful/lua-nginx-module, BSD)
...
http_upload http_ey_balancer http_slowfs_cache http_ndk http_lua"
...
src_install() {
	...
	if use nginx_modules_http_ndk; then
		...
		dodoc "${WORKDIR}"/${HTTP_NDK_MODULE_P}/README
	fi

	if use nginx_modules_http_lua; then
		docinto ${HTTP_LUA_MODULE_P}
		dodoc "${WORKDIR}"/${HTTP_LUA_MODULE_P}/{Changes,README}
	fi
