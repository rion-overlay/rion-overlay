...
#SRC_URI="mirror://sourceforge/project/${PN}/3%20-%20%SugarCRM%20${PV}/SugarCommunityEdition-${PV}/${MY_PN}-${PV}.zip"

SRC_URI="http://dl.sugarforge.org/${PN}/3${MY_PN}${PV}/${MY_PN}${PV}GA/${MY_PN}-${PV}.zip"
LICENSE="GPL-3"
KEYWORDS="~amd64 ~x86"
