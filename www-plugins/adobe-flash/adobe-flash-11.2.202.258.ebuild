...
MY_32B_DEBUGGER_URI="http://fpdownload.macromedia.com/pub/flashplayer/updaters/$(get_major_version)/flashplayer_$(get_major_version)_plugin_debug.i386.tar.gz -> ${P}-debug.i386.tar.gz"

DESCRIPTION="Adobe Flash Player"
SRC_URI="debugger? ( ${MY_32B_DEBUGGER_URI} )
!debugger? (
	x86? ( ${MY_32B_URI} )
	amd64? (
		multilib? (
...
IUSE="debugger multilib -32bit +64bit vdpau kde +sse2check"
REQUIRED_USE="debugger? ( || ( x86 ( multilib 32bit !64bit ) ) )"
SLOT="0"
...
src_unpack() {
	if [[ $amd64_32bit ]]; then
		...
		# elsewhere:
		local my_32b_src
		use debugger  && my_32b_src=${MY_32B_DEBUGGER_URI##*>} || my_32b_src=${MY_32B_URI##*>} 
