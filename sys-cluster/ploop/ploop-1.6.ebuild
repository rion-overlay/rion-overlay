...
RDEPEND="${DEPEND}
	|| ( >=sys-apps/openrc-0.11.8 sys-apps/systemd )
	"
...
src_install() {
	...
	newins "${FILESDIR}/ploop.tmpfiles" ploop.conf
}
...
pkg_postinst() {
	...
	elog ""
	elog "This ebuild install tmpfiles file - please add tmpfiles.setup service"
	elog "in defauil or boot ranlevel if you use openrc"
